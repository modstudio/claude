...
## Purpose
Deep context gathering after user confirms skill mode. Comprehensive, thorough, fetches from all sources.
...
## When to Use
- AFTER user confirms skill mode
...
- ❌ **Never proactively commit** - do not suggest or run `git commit` unless the user explicitly asks or the skill explicitly calls for it
